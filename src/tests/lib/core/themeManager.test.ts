...
describe('themeManager', () => {
  ...
  describe('loadTheme', () => {
    it('should load a new theme successfully', async () => {
      ...
      expect(mockLinkElement.setAttribute).toHaveBeenCalledWith('data-markdown-theme', 'github');
    ...
    it('should remove existing theme before loading new one', async () => {
      ...
      expect(mockQuerySelector).toHaveBeenCalledWith('link[data-markdown-theme]');
