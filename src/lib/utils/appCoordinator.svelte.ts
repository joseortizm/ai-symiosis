...
interface AppCoordinatorDeps {
  searchManager: ReturnType<typeof import('./searchManager.svelte').createSearchManager>;
  editorManager: ReturnType<typeof import('./editorManager.svelte').createEditorManager>;
  focusManager: ReturnType<typeof import('./focusManager.svelte').createFocusManager>;
}
